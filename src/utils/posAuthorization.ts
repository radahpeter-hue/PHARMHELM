 ...
 *
 * The effective `sales:operate` permission is resolved by AuthContext from the
 * user's primary role, secondary roles and any tenant role-realm overrides.
 * A hard-coded job-title whitelist here would create a second, conflicting RBAC
 * system and can cause valid POS operators to be rejected at checkout.
 */
